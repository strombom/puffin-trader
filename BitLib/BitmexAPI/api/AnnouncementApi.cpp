...
#include "BitmexAPI/api/AnnouncementApi.h"
...
AnnouncementApi::AnnouncementApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<std::vector<std::shared_ptr<Announcement>>> AnnouncementApi::announcement_get(boost::optional<utility::string_t> columns)
{


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/announcement");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("AnnouncementApi->announcement_get does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("AnnouncementApi->announcement_get does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        if (response.status_code() >= 400)
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling announcement_get: ") + response.reason_phrase()
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            if( contentType.find(responseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling announcement_get: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    {
        std::vector<std::shared_ptr<Announcement>> result;
        ...
        if(responseHttpContentType == utility::conversions::to_string_t("application/json"))
        {
            ...
            {
                std::shared_ptr<Announcement> itemObj(new Announcement());
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling announcement_get: unsupported response type"));
        }

        return result;
    });
}
pplx::task<std::vector<std::shared_ptr<Announcement>>> AnnouncementApi::announcement_getUrgent()
{


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/announcement/urgent");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("AnnouncementApi->announcement_getUrgent does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("AnnouncementApi->announcement_getUrgent does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling announcement_getUrgent: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling announcement_getUrgent: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling announcement_getUrgent: unsupported response type"));
        }
