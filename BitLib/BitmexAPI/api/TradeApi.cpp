...
TradeApi::TradeApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<std::vector<std::shared_ptr<Trade>>> TradeApi::trade_get(boost::optional<utility::string_t> symbol, boost::optional<utility::string_t> filter, boost::optional<utility::string_t> columns, boost::optional<double> count, boost::optional<double> start, boost::optional<bool> reverse, boost::optional<utility::datetime> startTime, boost::optional<utility::datetime> endTime)
{
    ...
    utility::string_t path = utility::conversions::to_string_t("/trade");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("TradeApi->trade_get does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("TradeApi->trade_get does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        if (response.status_code() >= 400)
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling trade_get: ") + response.reason_phrase()
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            if( contentType.find(responseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling trade_get: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        ...
        if(responseHttpContentType == utility::conversions::to_string_t("application/json"))
        {
            ...
            {
                std::shared_ptr<Trade> itemObj(new Trade());
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling trade_get: unsupported response type"));
        }
...
pplx::task<std::vector<std::shared_ptr<TradeBin>>> TradeApi::trade_getBucketed(boost::optional<utility::string_t> binSize, boost::optional<bool> partial, boost::optional<utility::string_t> symbol, boost::optional<utility::string_t> filter, boost::optional<utility::string_t> columns, boost::optional<double> count, boost::optional<double> start, boost::optional<bool> reverse, boost::optional<utility::datetime> startTime, boost::optional<utility::datetime> endTime)
{
    ...
    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/trade/bucketed");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("TradeApi->trade_getBucketed does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("TradeApi->trade_getBucketed does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling trade_getBucketed: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling trade_getBucketed: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        std::vector<std::shared_ptr<TradeBin>> result;
        ...
        if(responseHttpContentType == utility::conversions::to_string_t("application/json"))
        {
            ...
            for( auto& item : json.as_array() )
            {
                std::shared_ptr<TradeBin> itemObj(new TradeBin());
                itemObj->fromJson(item);
                result.push_back(itemObj);
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling trade_getBucketed: unsupported response type"));
        }
