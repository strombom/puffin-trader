...
#include "BitmexAPI/api/UserApi.h"
...
pplx::task<std::shared_ptr<Transaction>> UserApi::user_requestWithdrawal(utility::string_t currency, double amount, utility::string_t address, boost::optional<utility::string_t> otpToken, boost::optional<double> fee, boost::optional<utility::string_t> text)
{
