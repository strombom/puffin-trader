...
#include "BitmexAPI/api/GlobalNotificationApi.h"
...
GlobalNotificationApi::GlobalNotificationApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<std::vector<std::shared_ptr<GlobalNotification>>> GlobalNotificationApi::globalNotification_get()
{


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/globalNotification");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("GlobalNotificationApi->globalNotification_get does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("GlobalNotificationApi->globalNotification_get does not consume any supported media type"));
    }
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            if( contentType.find(responseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling globalNotification_get: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    {
        std::vector<std::shared_ptr<GlobalNotification>> result;
        ...
        if(responseHttpContentType == utility::conversions::to_string_t("application/json"))
        {
            ...
            {
                std::shared_ptr<GlobalNotification> itemObj(new GlobalNotification());
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling globalNotification_get: unsupported response type"));
        }
