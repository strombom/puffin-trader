...
#ifndef IO_SWAGGER_CLIENT_API_LiquidationApi_H_
#define IO_SWAGGER_CLIENT_API_LiquidationApi_H_


#include "../ApiClient.h"

#include "BitmexAPI/model/Error.h"
#include "BitmexAPI/model/Liquidation.h"
...
{
public:
    LiquidationApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~LiquidationApi();
    /// <summary>
    ...
    pplx::task<std::vector<std::shared_ptr<Liquidation>>> liquidation_get(
...
#endif /* IO_SWAGGER_CLIENT_API_LiquidationApi_H_ */
