...
#ifndef IO_SWAGGER_CLIENT_API_SettlementApi_H_
#define IO_SWAGGER_CLIENT_API_SettlementApi_H_
...
{
public:
    SettlementApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~SettlementApi();
    /// <summary>
    ...
    pplx::task<std::vector<std::shared_ptr<Settlement>>> settlement_get(
...
#endif /* IO_SWAGGER_CLIENT_API_SettlementApi_H_ */
