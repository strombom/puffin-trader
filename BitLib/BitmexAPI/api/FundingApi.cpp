...
#include "BitmexAPI/api/FundingApi.h"
...
FundingApi::FundingApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<std::vector<std::shared_ptr<Funding>>> FundingApi::funding_get(boost::optional<utility::string_t> symbol, boost::optional<utility::string_t> filter, boost::optional<utility::string_t> columns, boost::optional<double> count, boost::optional<double> start, boost::optional<bool> reverse, boost::optional<utility::datetime> startTime, boost::optional<utility::datetime> endTime)
{


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/funding");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("FundingApi->funding_get does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("FundingApi->funding_get does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        if (response.status_code() >= 400)
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling funding_get: ") + response.reason_phrase()
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            if( contentType.find(responseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling funding_get: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    {
        std::vector<std::shared_ptr<Funding>> result;
        ...
        if(responseHttpContentType == utility::conversions::to_string_t("application/json"))
        {
            ...
            {
                std::shared_ptr<Funding> itemObj(new Funding());
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling funding_get: unsupported response type"));
        }
