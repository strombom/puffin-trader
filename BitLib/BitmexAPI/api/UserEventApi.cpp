...
#include "BitmexAPI/api/UserEventApi.h"
...
UserEventApi::UserEventApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<std::vector<std::shared_ptr<UserEvent>>> UserEventApi::userEvent_get(boost::optional<double> count, boost::optional<double> startId)
{


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/userEvent");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("UserEventApi->userEvent_get does not produce any supported media type"));
    }
    ...
    if (startId)
    {
        queryParams[utility::conversions::to_string_t("startId")] = ApiClient::parameterToString(*startId);
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("UserEventApi->userEvent_get does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        if (response.status_code() >= 400)
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling userEvent_get: ") + response.reason_phrase()
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            if( contentType.find(responseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling userEvent_get: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    {
        std::vector<std::shared_ptr<UserEvent>> result;
        ...
        if(responseHttpContentType == utility::conversions::to_string_t("application/json"))
        {
            ...
            {
                std::shared_ptr<UserEvent> itemObj(new UserEvent());
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling userEvent_get: unsupported response type"));
        }
