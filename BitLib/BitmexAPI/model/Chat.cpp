...
#include "BitmexAPI/model/Chat.h"
...
void Chat::fromJson(web::json::value& val)
{
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("fromBot")];
        if(!fieldValue.is_null())
        {
            setFromBot(ModelBase::boolFromJson(fieldValue));
        }
    }
    if(val.has_field(utility::conversions::to_string_t("channelID")))
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("channelID")];
        if(!fieldValue.is_null())
        {
            setChannelID(ModelBase::doubleFromJson(fieldValue));
        }
    }
}
