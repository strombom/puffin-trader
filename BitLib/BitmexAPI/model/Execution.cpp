...
#include "BitmexAPI/model/Execution.h"
...
void Execution::fromJson(web::json::value& val)
{
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("underlyingLastPx")];
        if(!fieldValue.is_null())
        {
            setUnderlyingLastPx(ModelBase::doubleFromJson(fieldValue));
        }
    }
    if(val.has_field(utility::conversions::to_string_t("lastMkt")))
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("lastMkt")];
        if(!fieldValue.is_null())
        {
            setLastMkt(ModelBase::stringFromJson(fieldValue));
        }
    }
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("simpleOrderQty")];
        if(!fieldValue.is_null())
        {
            setSimpleOrderQty(ModelBase::doubleFromJson(fieldValue));
        }
    }
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("exDestination")];
        if(!fieldValue.is_null())
        {
            setExDestination(ModelBase::stringFromJson(fieldValue));
        }
    }
    ...
    if(val.has_field(utility::conversions::to_string_t("simpleLeavesQty")))
    {
        ...
        if(!fieldValue.is_null())
        {
            setSimpleLeavesQty(ModelBase::doubleFromJson(fieldValue));
        }
    }
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("simpleCumQty")];
        if(!fieldValue.is_null())
        {
            setSimpleCumQty(ModelBase::doubleFromJson(fieldValue));
        }
    }
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("multiLegReportingType")];
        if(!fieldValue.is_null())
        {
            setMultiLegReportingType(ModelBase::stringFromJson(fieldValue));
        }
    }
