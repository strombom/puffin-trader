...
void User::fromJson(web::json::value& val)
{
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("ownerId")];
        if(!fieldValue.is_null())
        {
            setOwnerId(ModelBase::doubleFromJson(fieldValue));
        }
    }
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("pgpPubKey")];
        if(!fieldValue.is_null())
        {
            setPgpPubKey(ModelBase::stringFromJson(fieldValue));
        }
    }
