...
#include "BitmexAPI/model/Settlement.h"
...
void Settlement::fromJson(web::json::value& val)
{
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("settlementType")];
        if(!fieldValue.is_null())
        {
            setSettlementType(ModelBase::stringFromJson(fieldValue));
        }
    }
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("bankrupt")];
        if(!fieldValue.is_null())
        {
            setBankrupt(ModelBase::doubleFromJson(fieldValue));
        }
    }
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("taxRate")];
        if(!fieldValue.is_null())
        {
            setTaxRate(ModelBase::doubleFromJson(fieldValue));
        }
    }
}
