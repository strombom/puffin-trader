...
public:
    ...
    /// 
    /// </summary>
    std::vector<utility::string_t>& getDisablePush();
    bool disablePushIsSet() const;
    void unsetDisablePush();
    void setDisablePush(std::vector<utility::string_t> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::vector<utility::string_t> m_DisablePush;
    bool m_DisablePushIsSet;
