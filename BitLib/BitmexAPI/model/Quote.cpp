...
#include "BitmexAPI/model/Quote.h"
...
void Quote::fromJson(web::json::value& val)
{
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("bidSize")];
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("askSize")];
        if(!fieldValue.is_null())
        {
