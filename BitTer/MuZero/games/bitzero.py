...
class MuZeroConfig:
    def __init__(self):
        ...
        self.fc_reward_layers = [16, 8]  # Define the hidden layers in the reward network
        self.fc_value_layers = [16, 8]  # Define the hidden layers in the value network
        self.fc_policy_layers = [16, 8]  # Define the hidden layers in the policy network
